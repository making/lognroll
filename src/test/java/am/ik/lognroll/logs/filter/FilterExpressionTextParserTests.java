...
import am.ik.lognroll.logs.filter.Filter.Key;
import am.ik.lognroll.logs.filter.Filter.Value;

import static org.assertj.core.api.Assertions.assertThat;
import static am.ik.lognroll.logs.filter.Filter.ExpressionType.AND;
import static am.ik.lognroll.logs.filter.Filter.ExpressionType.EQ;
import static am.ik.lognroll.logs.filter.Filter.ExpressionType.GTE;
import static am.ik.lognroll.logs.filter.Filter.ExpressionType.IN;
import static am.ik.lognroll.logs.filter.Filter.ExpressionType.LTE;
import static am.ik.lognroll.logs.filter.Filter.ExpressionType.NE;
import static am.ik.lognroll.logs.filter.Filter.ExpressionType.NIN;
import static am.ik.lognroll.logs.filter.Filter.ExpressionType.NOT;
import static am.ik.lognroll.logs.filter.Filter.ExpressionType.OR;
